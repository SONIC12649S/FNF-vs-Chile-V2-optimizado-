function onCreate()
	...
	makeAnimatedLuaSprite('papus2', 'Webiando_De_Noche/papus2', 880, 320);
	scaleObject('papus2', 1.65, 1.65);
	...
	addAnimationByPrefix('derecha', 'dance', 'derecha', 25, false);
	 ...
	 addAnimationByPrefix('papus2', 'idle', 'izquierda instance 10', 30, false);
...
function onBeatHit()
	...
	objectPlayAnimation('papus2', 'idle',true)
